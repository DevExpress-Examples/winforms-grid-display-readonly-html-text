...
Namespace DXSample
	...
	Public Class RepositoryItemHtmlLabel
		...
		Public Shared Sub RegisterCustomEdit()
			...
			EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(CustomEditName, GetType(HtmlLabel), GetType(RepositoryItemHtmlLabel), GetType(HtmlLabelViewInfo), New HtmlLabelPainter(), True, img))
		End Sub

		Private allowHtmlString_Renamed As Boolean

		<DefaultValue(False)> _
		Public Property AllowHtmlString() As Boolean
			Get
				Return allowHtmlString_Renamed
			End Get
			Set(ByVal value As Boolean)
				If allowHtmlString_Renamed <> value Then
					allowHtmlString_Renamed = value
					OnPropertiesChanged()
				End If
			End Set
		End Property
		...
		Public Overrides Sub Assign(ByVal item As RepositoryItem)
			...
			Try
				...
				If source Is Nothing Then
					Return
				End If
				allowHtmlString_Renamed = source.AllowHtmlString
			Finally
				EndUpdate()
			End Try
		End Sub
	...
	Public Class HtmlLabel
		...
		Public Shadows ReadOnly Property Properties() As RepositoryItemHtmlLabel
			Get
...
#Region "IHeightAdaptable Members"
        ...
        Public Function CalcHeight(ByVal cache As GraphicsCache, ByVal width As Integer) As Integer Implements IHeightAdaptable.CalcHeight
            Dim item_ As RepositoryItemHtmlLabel = TryCast(Item, RepositoryItemHtmlLabel)
            If item_.AllowHtmlString Then
...
#End Region
	...
	Public Class HtmlLabelPainter
		...
		Protected Overrides Sub DrawContent(ByVal info As ControlGraphicsInfoArgs)
			Dim rect As New Rectangle(info.ViewInfo.ContentRect.X, info.ViewInfo.ContentRect.Y, info.ViewInfo.ContentRect.Width, info.ViewInfo.ContentRect.Height)
